...
from services.transaction_analyzer import init_categories, categorize_transaction, analyze_transactions
...
class TestTransactionAnalyzer(unittest.TestCase):
    ...
    def test_categorize_transaction(self):
        ...
        transport_category_id = categorize_transaction('Проезд в метро', 'Московский метрополитен')
    ...
    def test_analyze_transactions(self):
        ...
        data = {
            ...
            'category_name': ['Продукты', 'Рестораны', 'Продукты', 'Транспорт', 'Развлечения'],
            'transaction_date': [
                datetime(2023, 1, 1),
                datetime(2023, 1, 2),
                datetime(2023, 1, 3),
...
class TestAIRecommendation(unittest.TestCase):
    ...
    def test_rule_based_recommendations(self):
        ...
        for recommendation in recommendations:
            ...
            self.assertLessEqual(recommendation['potential_savings'], financial_data['total_spending'])
